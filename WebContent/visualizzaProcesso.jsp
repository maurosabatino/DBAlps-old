<%@page import="controller.ControllerDatabase"%>
<%@page import="bean.Processo"%>
...
<%Processo p = ControllerDatabase.prendiProcesso(44); %>
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

<div class="row"><h2><%=p.getNome()%> </h2></div>

<div class="row"><h2><small><%=p.getData().toLocaleString() %></small></h2> </div>
